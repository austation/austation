/datum/game_mode/devil
	...
	protected_jobs = list("Lawyer", "Curator", "Chaplain", "Head of Security", "Head of Personnel", "Captain", "AI", "Cyborg", "Security Officer", "Warden", "Detective", "Brig Physician", "Prisoner") // austation -- HOP can no longer be antag, prisoner role
	required_players = 0
	required_enemies = 1
