...
/datum/game_mode/gang
	...
	restricted_jobs = list("Security Officer", "Warden", "Detective", "AI", "Cyborg","Captain", "Head of Personnel", "Head of Security", "Brig Physician", "Prisoner") //austation -- Prisoner role
	required_players = 15
	required_enemies = 1
