...
/datum/game_mode/revolution
	...
	restricted_jobs = list("Security Officer", "Warden", "Detective", "AI", "Cyborg","Captain", "Head of Personnel", "Head of Security", "Chief Engineer", "Research Director", "Chief Medical Officer", "Brig Physician", "Prisoner") //austation -- prisoner role
	required_players = 30
	required_enemies = 2
