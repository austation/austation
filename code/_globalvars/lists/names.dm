...
GLOBAL_LIST_INIT(commando_names, world.file2list("austation/strings/names/death_commando.txt")) // austation -- keep the old funny deathsquad names
...
//Austation begin -- Enriched selection of squid names
GLOBAL_LIST_INIT(squid_names_male, world.file2list("austation/strings/names/squid_male.txt"))
GLOBAL_LIST_INIT(squid_names_female, world.file2list("austation/strings/names/squid_female.txt"))
//Austation end
