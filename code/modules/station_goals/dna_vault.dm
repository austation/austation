...
/obj/machinery/dna_vault/proc/upgrade(mob/living/carbon/human/H,upgrade_type)
	...
	switch(upgrade_type)
		...
		if(VAULT_SPEED)
			...
			H.add_movespeed_modifier(MOVESPEED_ID_DNA_VAULT, update=TRUE, priority=100, multiplicative_slowdown=-1, blacklisted_movetypes=(FLYING|FLOATING)) // austation -- revert stoopid movespeed changes
		if(VAULT_QUICK)
