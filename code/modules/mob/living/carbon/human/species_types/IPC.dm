/datum/species/ipc
	...
	sexes = FALSE
<<<<<<< HEAD
	species_traits = list(NOTRANSSTING,NOEYESPRITES,NO_DNA_COPY,NOZOMBIE,REVIVESBYHEALING,NOHUSK,NOMOUTH,MUTCOLORS,NO_UNDERWEAR)
	inherent_traits = list(TRAIT_RESISTCOLD,TRAIT_NOBREATH,TRAIT_LIMBATTACHMENT,TRAIT_NOCRITDAMAGE,TRAIT_EASYDISMEMBER,TRAIT_POWERHUNGRY,TRAIT_XENO_IMMUNE, TRAIT_TOXIMMUNE,TRAIT_MUTATEIMMUNE,TRAIT_TOXIMMUNE) // austation -- IPC radiation interaction
=======
