/datum/species/ipc
	...
	inherent_traits = list(TRAIT_RESISTCOLD,TRAIT_NOBREATH,TRAIT_LIMBATTACHMENT,TRAIT_EASYDISMEMBER,TRAIT_POWERHUNGRY,TRAIT_XENO_IMMUNE, TRAIT_TOXIMMUNE,TRAIT_MUTATEIMMUNE,TRAIT_TOXIMMUNE) // austation -- IPC radiation interaction
