/datum/species/ipc // im fucking lazy mk2 and cant get sprites to normally work
	...
	inherent_traits = list(TRAIT_RESISTCOLD,TRAIT_NOBREATH,TRAIT_LIMBATTACHMENT,TRAIT_NOCRITDAMAGE,TRAIT_EASYDISMEMBER,TRAIT_POWERHUNGRY,TRAIT_XENO_IMMUNE,TRAIT_MUTATEIMMUNE,TRAIT_TOXIMMUNE) // austation -- IPC radiation interaction
