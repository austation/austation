...
<<<<<<< HEAD
	inherent_traits = list(TRAIT_RESISTCOLD,TRAIT_NOBREATH,TRAIT_LIMBATTACHMENT,TRAIT_NOCRITDAMAGE,TRAIT_EASYDISMEMBER,TRAIT_MUTATEIMMUNE,TRAIT_TOXIMMUNE) // austation -- IPC radiation interaction
=======
...
>>>>>>> ae3457451c... Electrical species rework (#5127)
