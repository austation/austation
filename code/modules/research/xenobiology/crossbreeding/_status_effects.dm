...
/datum/status_effect/stabilized/sepia/tick()
	if(prob(50) && mod > -1)
		mod--
		owner.add_movespeed_modifier(MOVESPEED_ID_SEPIA, override = TRUE, update=TRUE, priority=100, multiplicative_slowdown=-1, blacklisted_movetypes=(FLYING|FLOATING)) // austation -- revert stoopid movespeed changes
	else if(mod < 1)
		mod++
