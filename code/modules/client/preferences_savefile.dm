...
/datum/preferences/proc/load_preferences()
	...
	READ_FILE(S["screentip_color"], screentip_color) //austation -- hovertexts
	...
	READ_FILE(S["screentip_pref"], screentip_pref)  //austation -- hovertexts
	...
	screentip_color = sanitize_ooccolor(sanitize_hexcolor(screentip_color, 6, 1, initial(screentip_color))) //austation -- hovertexts
...
/datum/preferences/proc/save_preferences()
	...
	WRITE_FILE(S["screentip_color"], screentip_color) //austation -- hovertexts
	...
	WRITE_FILE(S["screentip_pref"], screentip_pref) //austation -- hovertexts
