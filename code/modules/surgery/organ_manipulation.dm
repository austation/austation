...
/datum/surgery_step/manipulate_organs
	...
	var/implements_extract = list(TOOL_HEMOSTAT = 100, TOOL_CROWBAR = 55, /obj/item/shovel/spade = 40, /obj/item/cultivator = 30, /obj/item/kitchen/fork = 20) //Austation note: adds spade, cultivator and fork as ghetto alternatives.
	var/current_type
