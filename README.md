...
[![Build Status](https://travis-ci.com/austation/austation.png)](https://travis-ci.com/austation/austation) [![Krihelimeter](https://www.krihelinator.xyz/badge/austation/austation)](https://www.krihelinator.xyz)  
[![Percentage of issues still open](https://isitmaintained.com/badge/open/austation/austation.svg)](https://isitmaintained.com/project/austation/austation "Percentage of issues still open") [![Average time to resolve an issue](https://isitmaintained.com/badge/resolution/austation/austation.svg)](https://isitmaintained.com/project/austation/austation "Average time to resolve an issue") ![Coverage](https://img.shields.io/badge/coverage---2%25-red.svg)  
...
```
docker run -d -p <your port>:1337 -v /path/to/your/config:/austation/config -v /path/to/your/data:/austation/data austation/austation <dream daemon options i.e. -public or -params>
```
