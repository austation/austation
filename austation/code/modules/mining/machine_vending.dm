...
/obj/machinery/mineral/equipment_vendor/Initialize()
	for(var/datum/data/mining_equipment/I in prize_list)  //  prize_list is populated by elements, all of the exact same class; we can only tell them apart by checking their equimpent_path
