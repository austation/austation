...
/datum/antagonist/vamphunter/greet()
	...
	owner.current.playsound_local(null, 'sound/weapons/chunkyrack.ogg', 100, FALSE, pressure_affected = FALSE)
...
/datum/action/bloodsucker/trackvamp/
	...
	button_icon = 'austation/icons/Fulpicons/fulpicons.dmi'	//This is the file for the BACKGROUND icon
	background_icon_state = "vamp_power_off"		//And this is the state for the background icon
	icon_icon = 'austation/icons/Fulpicons/fulpicons.dmi'		//This is the file for the ACTION icon
