...
/obj/item/stake/
	...
	icon = 'austation/icons/Fulpicons/fulpitems.dmi'
	icon_state = "wood" // Inventory Icon
	//inhand_icon_state = "wood" // In-hand Icon
	lefthand_file = 'austation/icons/mob/inhands/fulpitems_hold_left.dmi' // File for in-hand icon
	righthand_file = 'austation/icons/mob/inhands/fulpitems_hold_right.dmi'
