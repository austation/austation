...
/obj/structure/closet/crate/coffin/blackcoffin // closet.dmi, closets.dm, and job_closets.dm
	...
	icon_state = "coffin"
	icon = 'austation/icons/Fulpicons/fulpobjects.dmi'
	can_weld_shut = FALSE
	resistance_flags = 0			// Start off with no bonuses.
	open_sound = 'austation/sound/misc/coffin_open.ogg'//'sound/machines/door_open.ogg'
	close_sound = 'austation/sound/misc/coffin_close.ogg'//'sound/machines/door_close.ogg'
	breakout_time = 600
	pryLidTimer = 400
