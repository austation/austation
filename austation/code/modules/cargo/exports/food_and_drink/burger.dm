...
/datum/export/redburger
	cost = 19
	unit_name = "Red burger"
	export_types = list(/obj/item/reagent_containers/food/snacks/burger/red)

/datum/export/orangeburger
	cost = 19
	unit_name = "Orange burger"
	export_types = list(/obj/item/reagent_containers/food/snacks/burger/orange)

/datum/export/yellowburger
	cost = 19
	unit_name = "Yellow burger"
	export_types = list(/obj/item/reagent_containers/food/snacks/burger/yellow)

/datum/export/greenburger
	cost = 19
	unit_name = "Green burger"
	export_types = list(/obj/item/reagent_containers/food/snacks/burger/green)

/datum/export/blueburger
	cost = 19
	unit_name = "Blue burger"
	export_types = list(/obj/item/reagent_containers/food/snacks/burger/blue)

/datum/export/purpleburger
	cost = 20
	unit_name = "Purple burger"
	export_types = list(/obj/item/reagent_containers/food/snacks/burger/purple)

/datum/export/blackburger
	cost = 20
	unit_name = "Black burger"
	export_types = list(/obj/item/reagent_containers/food/snacks/burger/black)
...
/datum/export/soylentburger
	cost = 66
	unit_name = "Soylent Burger"
	export_types = list(/obj/item/reagent_containers/food/snacks/burger/soylent)

/datum/export/ribburger
	cost = 66
	unit_name = "McRib"
	export_types = list(/obj/item/reagent_containers/food/snacks/burger/rib)

/datum/export/mcguffin
	cost = 30
	unit_name = "McGuffin"
